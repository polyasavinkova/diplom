...
<body>
    ...
    <div class="container" style="margin-top: 70px;">
        <div class="row">
            ...
            <div class="task">
            <h5>Задание:</h5>
                    <p>Используя свойство justify-content и align-items вместе, переместите квадрат в центр</p>
                ...
                <div class="codee">
                    <code>
                        # square {<br>
                        display: flex;<br>
                         justify-content:<input class="param1" type="text">; <br>
    ...
    <div>
            ...
            <a href="../tasks/trainer5.php" id="next-trainer">Дальше</a>
        </div>
    </div>
    ...
    <script>
        ...
        $('.param1').on('input', function () {
            if ($('.param1').val() == 'center') {
                $('.block').css('justify-content', $('.param1').val());
                score++;
                ckeck();
            }
        })
